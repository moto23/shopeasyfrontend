...
function equi1() {
  ...
  <div class="row align-items-start py-3">
    <div class="col-lg-2">
    <img src='https://cdn-icons-png.flaticon.com/128/6831/6831000.png' class="img-fluid"></img>
    <h6>Free Delivery</h6>
    </div>
    <div class="col-lg-2">
    <img src='https://cdn-icons-png.flaticon.com/128/754/754616.png'  class="img-fluid"></img>
    <h6>30 Days Replacement</h6>
    </div>
    <div class="col-lg-2">
    <img src='https://cdn-icons-png.flaticon.com/128/6491/6491515.png' class="img-fluid"></img>
    <h6>Pay on delivery</h6>
    </div>
    <div class="col-lg-2">
    <img src='https://cdn-icons-png.flaticon.com/128/11526/11526511.png' class="img-fluid"></img>
